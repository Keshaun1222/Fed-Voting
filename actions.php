    ...
    <div class="site-wrapper-inner">
        <div class="cover-container">
            ...
            <div class="inner cover">
                ...
                <h3 class="cover-heading pull-left"><a href="new.php">Add a New Election</a></h3><br /><br /><br />
                <h3 class="cover-heading pull-left"><a href="cancel.php">Cancel an Election</a></h3><br /><br /><br />
                <h3 class="cover-heading pull-left"><a href="add.php">Add Candidates for an Election</a></h3><br /><br /><br />
